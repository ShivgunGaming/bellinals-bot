...
const brc20Verifications = rewire('../../commands/brc20/brc20-verifications')
const errorEmbed = require('../../embed/error-embed')
const infoEmbed = require('../../embed/info-embed')
const Brc20s = require('../../db/brc20s')

describe('brc20-verifications', () => {
  ...
  it('should display brc20s and their associated roles and brc20 counts', async () => {
    ...
    await brc20Verifications.execute(interactionStub)
    ...
    expect(embeds[0].data.title).to.equal(
      infoEmbed('Verifications Brc20s', 'Brc20s, their associated role and brc20 count.').data.title
    )
